...
export class Level5 extends BaseScene {
  ...
  addObjective() {
    ...
    if (trash.type === this.currentTarget) {
      ...
      this.objective = Math.max(0, this.objective - 1);
  ...
  onCollision(x, y) {
    ...
    for (const dir of directions) {
      ...
      bolt.graphics.use(sprites[rand.integer(0, sprites.length - 1)]);
